...
// src/components/anotherButton/index.ts
var anotherButton_exports = {};
__export(anotherButton_exports, {
  AnotherButton: () => AnotherButton_default
});
module.exports = __toCommonJS(anotherButton_exports);
